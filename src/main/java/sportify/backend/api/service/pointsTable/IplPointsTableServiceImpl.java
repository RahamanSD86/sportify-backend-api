...
public class IplPointsTableServiceImpl implements IplPointsTableService{
    ...
    public IplPointsTableDto createEntity(String teamName)throws Exception{
          ...
          int p=0; int w=0; int l=0; int totalrunsScored=0; int totalRunsConceded=0; double totalOverFaced=0; double totalOverBowled=0;
        ...
        IplPointsTableDto iplPointsTableDto=new IplPointsTableDto();
        ...
        iplPointsTableDto.setNR(String.valueOf(runRate));
        iplPointsTableDto.setNRR(String.valueOf(netRunRate));
        iplPointsTableDto.setFOR(totalrunsScored +"/"+ totalOverFaced);
        iplPointsTableDto.setAGAINST(totalRunsConceded+"/"+totalOverBowled);
        iplPointsTableDto.setPTS(String.valueOf(w*2));
